...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Vote.non_votes_count'
        db.add_column('laws_vote', 'non_votes_count',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Vote.non_votes_count'
        db.delete_column('laws_vote', 'non_votes_count')
    ...
    models = {
        ...
        'laws.vote': {
            ...
            'non_votes_count': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
