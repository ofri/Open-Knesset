...
from video.management.commands.sub_commands.tests.UpdateMembersAboutVideo import testUpdateMembersAboutVideo
from video.management.commands.sub_commands.tests.UpdateMembersRelatedVideos import testUpdateMembersRelatedVideos
from video.management.commands.sub_commands.tests.UpdateCommitteesVideos import testUpdateCommitteesVideos
from video.management.commands.sub_commands.tests.AddVideo import testAddVideo
from video.management.commands.sub_commands.tests.DownloadCommitteesVideos import testDownloadCommitteesVideos
from video.management.commands.sub_commands.tests.UploadCommitteesVideos import testUploadCommitteesVideos
