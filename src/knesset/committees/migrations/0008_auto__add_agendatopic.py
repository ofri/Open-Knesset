...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'AgendaTopic'
        db.create_table('committees_agendatopic', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('topic', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['topics.Topic'])),
            ('committee', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['committees.Committee'], null=True)),
        ...
        db.send_create_signal('committees', ['AgendaTopic'])


    def backwards(self, orm):
        
        # Deleting model 'AgendaTopic'
        db.delete_table('committees_agendatopic')
    ...
    models = {
        ...
        'committees.agendatopic': {
            'Meta': {'object_name': 'AgendaTopic'},
            'committee': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['committees.Committee']", 'null': 'True'}),
        ...
        'committees.committee': {
            ...
            'agenda_topics': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'committees'", 'symmetrical': 'False', 'through': "orm['committees.AgendaTopic']", 'to': "orm['topics.Topic']"}),
        ...
        'topics.topic': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'agenda_items'", 'to': "orm['auth.User']"}),
