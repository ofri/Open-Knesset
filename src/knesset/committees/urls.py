...
committeesurlpatterns = patterns ('',
    ...
    url(r'^committee/(?P<committee_id>\d+)/topic/$', AgendaTopicListView.as_view(), name ='committee-topic-list'),
    ...
    url(r'^committee/topic/$', AgendaTopicListView.as_view(), name='topic-list'),
)
