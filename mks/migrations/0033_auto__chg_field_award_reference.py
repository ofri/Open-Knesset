...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Award.reference'
        db.alter_column(u'mks_award', 'reference', self.gf('django.db.models.fields.URLField')(max_length=1000))

    def backwards(self, orm):

        # Changing field 'Award.reference'
        db.alter_column(u'mks_award', 'reference', self.gf('django.db.models.fields.URLField')(max_length=200))
