...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'HourlyPresence.date_end'
        db.alter_column('mks_hourlypresence', 'date_end', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'HourlyPresence.date_start'
        db.alter_column('mks_hourlypresence', 'date_start', self.gf('django.db.models.fields.DateTimeField')(null=True))

    def backwards(self, orm):

        # Changing field 'HourlyPresence.date_end'
        db.alter_column('mks_hourlypresence', 'date_end', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'HourlyPresence.date_start'
        db.alter_column('mks_hourlypresence', 'date_start', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        'mks.hourlypresence': {
            'Meta': {'object_name': 'HourlyPresence'},
