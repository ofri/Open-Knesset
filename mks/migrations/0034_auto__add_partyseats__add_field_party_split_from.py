...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal(u'mks', ['PartySeats'])

        # Adding field 'Party.split_from'
        db.add_column(u'mks_party', 'split_from',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mks.Party'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'PartySeats'
        db.delete_table(u'mks_partyseats')

        # Deleting field 'Party.split_from'
        db.delete_column(u'mks_party', 'split_from_id')
