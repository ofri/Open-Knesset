...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AwardType'
        db.create_table(u'mks_awardtype', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('valence', self.gf('django.db.models.fields.FloatField')(default=0)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'mks', ['AwardType'])

        # Adding model 'Award'
        db.create_table(u'mks_award', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('award_type', self.gf('django.db.models.fields.related.ForeignKey')(related_name='awards', to=orm['mks.AwardType'])),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(related_name='awards', to=orm['mks.Member'])),
        ...
        db.send_create_signal(u'mks', ['Award'])


    def backwards(self, orm):
        # Deleting model 'AwardType'
        db.delete_table(u'mks_awardtype')

        # Deleting model 'Award'
        db.delete_table(u'mks_award')
    ...
    models = {
        ...
        u'mks.award': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'member': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'awards'", 'to': u"orm['mks.Member']"}),
