...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Suggestion.suggested_field'
        db.delete_column('suggestions_suggestion', 'suggested_field')
    ...
    def backwards(self, orm):
        # Adding field 'Suggestion.suggested_field'
        db.add_column('suggestions_suggestion', 'suggested_field',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)
