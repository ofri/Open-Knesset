...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Suggestion.content_type'
        db.delete_column('suggestions_suggestion', 'content_type_id')

        # Adding field 'Suggestion.subject_ct'
        db.add_column('suggestions_suggestion', 'subject_ct',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='suggestion_subject', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Suggestion.content_type'
        db.add_column('suggestions_suggestion', 'content_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='suggestion_content', null=True, to=orm['contenttypes.ContentType'], blank=True),
                      keep_default=False)
