...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('suggestions_suggestion', 'content', self.gf('jsonfield.fields.JSONField')())

    def backwards(self, orm):

        # Changing field 'Suggestion.content'
        db.alter_column('suggestions_suggestion', 'content', self.gf('django.db.models.fields.TextField')())
