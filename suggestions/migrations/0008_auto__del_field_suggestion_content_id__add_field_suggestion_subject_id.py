...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Suggestion.content_id'
        db.delete_column('suggestions_suggestion', 'content_id')
    ...
    def backwards(self, orm):
        # Adding field 'Suggestion.content_id'
        db.add_column('suggestions_suggestion', 'content_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(null=True, blank=True),
                      keep_default=False)
