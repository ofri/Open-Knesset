...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Suggestion.action'
        db.add_column('suggestions_suggestion', 'action',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Suggestion.suggestion_action'
        raise RuntimeError("Cannot reverse this migration. 'Suggestion.suggestion_action' and its values cannot be restored.")
        # Deleting field 'Suggestion.action'
        db.delete_column('suggestions_suggestion', 'action')
