...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Feedback.suggested_at'
        db.add_column(u'auxiliary_feedback', 'suggested_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Feedback.suggested_at'
        db.delete_column(u'auxiliary_feedback', 'suggested_at')
