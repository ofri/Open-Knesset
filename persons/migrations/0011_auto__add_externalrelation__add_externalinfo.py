...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ExternalRelation'
        db.create_table(u'persons_externalrelation', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='external_relation', to=orm['persons.Person'])),
            ('relationship', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('with_person', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.Person'], null=True, blank=True)),
        ))
        db.send_create_signal(u'persons', ['ExternalRelation'])

        # Adding model 'ExternalInfo'
        db.create_table(u'persons_externalinfo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='external_info', to=orm['persons.Person'])),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('value', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'persons', ['ExternalInfo'])


    def backwards(self, orm):
        # Deleting model 'ExternalRelation'
        db.delete_table(u'persons_externalrelation')

        # Deleting model 'ExternalInfo'
        db.delete_table(u'persons_externalinfo')
    ...
    models = {
        ...
        u'persons.externalinfo': {
            'Meta': {'object_name': 'ExternalInfo'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'external_info'", 'to': u"orm['persons.Person']"}),
            'source': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'value': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'})
        },
        u'persons.externalrelation': {
            'Meta': {'object_name': 'ExternalRelation'},
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'person': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'external_relation'", 'to': u"orm['persons.Person']"}),
            'relationship': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'source': ('django.db.models.fields.CharField', [], {'max_length': '64'}),
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'with_person': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['persons.Person']", 'null': 'True', 'blank': 'True'})
        },
        u'persons.person': {
