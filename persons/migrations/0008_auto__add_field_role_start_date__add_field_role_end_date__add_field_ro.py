...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'persons_role', 'start_date',
                      self.gf('django.db.models.fields.DateField')(null=True),
                      keep_default=False)

        # Adding field 'Role.end_date'
        db.add_column(u'persons_role', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Role.org'
        db.add_column(u'persons_role', 'org',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'Person.img_url'
        db.alter_column(u'persons_person', 'img_url', self.gf('django.db.models.fields.URLField')(max_length=1024))

    def backwards(self, orm):
        # Deleting field 'Role.start_date'
        db.delete_column(u'persons_role', 'start_date')

        # Deleting field 'Role.end_date'
        db.delete_column(u'persons_role', 'end_date')

        # Deleting field 'Role.org'
        db.delete_column(u'persons_role', 'org')


        # Changing field 'Person.img_url'
        db.alter_column(u'persons_person', 'img_url', self.gf('django.db.models.fields.URLField')(max_length=1000))
