...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Person.calendar_url'
        db.add_column(u'persons_person', 'calendar_url',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Person.calendar_sync_token'
        db.add_column(u'persons_person', 'calendar_sync_token',
                      self.gf('django.db.models.fields.CharField')(max_length=1024, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Person.calendar_url'
        db.delete_column(u'persons_person', 'calendar_url')

        # Deleting field 'Person.calendar_sync_token'
        db.delete_column(u'persons_person', 'calendar_sync_token')
