...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'LobbyistCorporationAlias'
        db.create_table(u'lobbyists_lobbyistcorporationalias', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('main_corporation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lobbyistcorporationalias_main', to=orm['lobbyists.LobbyistCorporation'])),
            ('alias_corporation', self.gf('django.db.models.fields.related.ForeignKey')(related_name='lobbyistcorporationalias_alias', unique=True, to=orm['lobbyists.LobbyistCorporation'])),
        ))
        db.send_create_signal(u'lobbyists', ['LobbyistCorporationAlias'])


    def backwards(self, orm):
        # Deleting model 'LobbyistCorporationAlias'
        db.delete_table(u'lobbyists_lobbyistcorporationalias')
