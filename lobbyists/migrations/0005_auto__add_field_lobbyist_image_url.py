...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lobbyist.image_url'
        db.add_column(u'lobbyists_lobbyist', 'image_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lobbyist.image_url'
        db.delete_column(u'lobbyists_lobbyist', 'image_url')
