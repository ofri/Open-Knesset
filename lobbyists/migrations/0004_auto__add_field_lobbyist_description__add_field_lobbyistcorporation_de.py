...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Lobbyist.description'
        db.add_column(u'lobbyists_lobbyist', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'LobbyistCorporation.description'
        db.add_column(u'lobbyists_lobbyistcorporation', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Lobbyist.description'
        db.delete_column(u'lobbyists_lobbyist', 'description')

        # Deleting field 'LobbyistCorporation.description'
        db.delete_column(u'lobbyists_lobbyistcorporation', 'description')
