...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field represents on 'Lobbyist'
        m2m_table_name = db.shorten_name(u'lobbyists_lobbyist_represents')
        ...
        db.create_unique(m2m_table_name, ['lobbyist_id', 'lobbyistrepresent_id'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field represents on 'Lobbyist'
        db.delete_table(db.shorten_name(u'lobbyists_lobbyist_represents'))
