					...
					"ui.tabs",
					{
						...
						destroy : function() {
							...
							this.anchors.each(function() {
								...
								d.each( [ "href", "load", "cache" ], function(
										c, h) {
									b.removeData(h + ".tabs")
								})
							});
...
jQuery.effects
		|| function(f, j) {
			...
			f.effects = {};
			f.each( [ "backgroundColor", "borderBottomColor",
	...
	c.effects.size = function(b) {
		return this
				.queue(function() {
					...
					if (m == "content" || m == "both") {
						f = f.concat( [ "marginTop", "marginBottom" ])
								.concat(i);
